...
public class ModPotions {
    public static final RegistryEntry<Potion> LUCKY_POTION = registerPotion("lucky_potion",
            new Potion(new StatusEffectInstance(StatusEffects.SPEED, 600, 1),
                    new StatusEffectInstance(StatusEffects.STRENGTH, 600, 1)));

    private static RegistryEntry<Potion> registerPotion(String name, Potion potion) {
        return Registry.registerReference(Registries.POTION, Identifier.of(GamblingPotions.MOD_ID, name), potion);
    }
